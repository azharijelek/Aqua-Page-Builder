### This Plugin is Modified version by Azhari Subroto. Since this version have a lot of changes, I decided to not to merge this version to the original one. And sorry for my terrible english.
